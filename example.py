...
# 永续合约API
    ...
    # 单个合约持仓信息 （20次/2s）
    # result = swapAPI.get_specific_position('LTC-USD-SWAP')
    ...
    result = swapAPI.get_order_info('LTC-USD-SWAP', '2')
    ...
    # 获取委托单列表 （20次/2s）
    # result = swapAPI.get_order_algos('LTC-USD-SWAP', '1', algo_id='', status='2')
